...
需求分析过程
* 点：用户提出的一个个个需求点，往往是独立的或者片面的
* 线：归纳、总结和扩展一个个需求点，把需求点串联成线，从而形成一类或者一组需求线。
* 面: 结合业务规范和业务发展，大量的需求线进行归类和合并，相互交织成为整个需求的面。
...
领域驱动设计（Domain-Driven Design：DDD）是一种设计理念或者方法论。
