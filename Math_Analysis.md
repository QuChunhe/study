...
* 公理化：三套公理：1）存在性：存在一个结构满足如下公理；2）唯一性：满足如下公理的仅仅有一个
   ...
   3. 完备性
* Dekekind分割   
* 无限小数：两个无限小数对应一个实数， 0.9的循环=1.0的循环
* Cauchy列/Cantor列
...
可见稠密的有理数集Q其实是有缝隙的，而且不难发现这缝隙非常多。事实上，这些缝隙所构成的集合也是稠密的。我们把Q与这个“缝隙集”融合到一起，所构成的新整体就是全体实数的集合R 。这个过程很奇妙：从代数角度看叫做“扩域”，从分析角度看叫做“完备化”
